...
export const Footer = () => {
    return <footer className="w-full text-white text-center py-4 flex flex-col gap-4 justify-center">
        ...
        <ul className="flex w-full gap-4 justify-center text-sm"> 
           <li className="hover:scale-110"><Link target="_blank" key='github' href={'https://github.com/gcangela'}><GitHubIcon width={32} height={32} /></Link></li> 
           <li className="hover:scale-110"><Link target="_blank" key='linkedin' href={'https://www.linkedin.com/in/giancarlo-angela/'}><LinkedInIcon width={32} height={32} /></Link></li> 
             </ul>
    </footer>
}