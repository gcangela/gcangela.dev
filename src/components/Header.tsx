...
export const Header = () => {
    return <header className="sticky top-0 left-0 right-0 bg-black text-white z-50 h-[var(--header-height)] px-6">
        <div className=" size-full flex gap-4 items-center justify-start sm:justify-between">
            <Link href="/" className="!no-underline">
                <div className="flex gap-2 items-center justify-center text-2xl font-bold font-mono">
                    <span>GC</span>
                    <div className="mx-2 bg-white w-px h-[var(--header-height)]"></div>
